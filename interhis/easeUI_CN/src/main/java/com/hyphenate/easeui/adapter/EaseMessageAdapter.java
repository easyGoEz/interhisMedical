...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    protected EaseChatRow createChatRow(Context context, EMMessage message, int position, String imgDoc, String imgPat) {
        ...
        switch (message.getType()) {
            case TXT:
                if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    chatRow = new EaseChatRowBigExpression(context, message, position, this, imgDoc, imgPat);
                ...
                break;
            case LOCATION:
                chatRow = new EaseChatRowLocation(context, message, position, this, imgDoc, imgPat);
                break;
            case FILE:
                chatRow = new EaseChatRowFile(context, message, position, this, imgDoc, imgPat);
                break;
            case IMAGE:
                chatRow = new EaseChatRowImage(context, message, position, this, imgDoc, imgPat);
                break;
            case VOICE:
                chatRow = new EaseChatRowVoice(context, message, position, this, imgDoc, imgPat);
                break;
            case VIDEO:
                chatRow = new EaseChatRowVideo(context, message, position, this, imgDoc, imgPat);
                break;
            default:
                break;
        }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        EMMessage message = getItem(position);
        if (convertView == null) {
            convertView = createChatRow(context, message, position, imgDoc, imgPat);
        }
