...
public class EaseContactAdapter extends ArrayAdapter<EaseUser> implements SectionIndexer {
    ...
    public EaseContactAdapter(Context context, int resource, List<EaseUser> objects, String imgDoc, String imgPat) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EaseUserUtils.setUserAvatar(getContext(), username, holder.avatar, imgPat);
