...
public class EaseNotifier {
     ...
     * @return
     */
    public EaseNotifier init(Context context, Class activity) {
        appContext = context;
...
//            }
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(appContext, notifyID, intent, PendingIntent.FLAG_CANCEL_CURRENT);
