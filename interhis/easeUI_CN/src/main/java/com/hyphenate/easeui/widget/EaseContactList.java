...
public class EaseContactList extends RelativeLayout {
     ...
     * init view
     */
    public void init(List<EaseUser> contactList, String imgDoc, String imgPat) {
        this.contactList = contactList;
        adapter = new EaseContactAdapter(context, 0, new ArrayList<EaseUser>(contactList), imgDoc, imgPat);
